                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="bg-gray-100 shadow-md p-4 rounded-lg max-h-[300px] overflow-y-auto">
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-100 shadow-md p-4 rounded-lg mb-4">
                                <h3 class="font-semibold mb-2">Pekerjaan <span class="bg-yellow-200 text-yellow-800 px-2 py-1 rounded-full text-xs">On Duty</span></h3>
                                <div class="overflow-auto max-h-[255px]">
                                    <table class="table-auto w-full">
                                        <thead>
