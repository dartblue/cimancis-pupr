                    ...
                    <form action="{{ route('alat-berat.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="nomor_lambung" id="nomor_lambung" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="tahun" id="tahun" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                            </div>
                            <div>
                                <label for="merek" class="block text-sm font-medium text-gray-700">Merek<span class="text-red-500">*</span></label>
                                <input type="text" name="merek" id="merek" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="location" id="location" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                            </div>
                            <div>
                                <label for="hours_meter" class="block text-sm font-medium text-gray-700">Hours Meter</label>
                                <input type="text" name="hours_meter" id="hours_meter" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="mt-6">
